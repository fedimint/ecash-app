...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1931168122;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        66 => wire__crate__nostr__NostrClient_set_nwc_connection_info_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        89 => wire__crate__ack_seed_phrase_impl(port, ptr, rust_vec_len, data_len),
        90 => wire__crate__allocate_deposit_address_impl(port, ptr, rust_vec_len, data_len),
        91 => wire__crate__await_ecash_reissue_impl(port, ptr, rust_vec_len, data_len),
        92 => wire__crate__await_ecash_send_impl(port, ptr, rust_vec_len, data_len),
        93 => wire__crate__await_receive_impl(port, ptr, rust_vec_len, data_len),
        94 => wire__crate__await_send_impl(port, ptr, rust_vec_len, data_len),
        95 => wire__crate__await_withdraw_impl(port, ptr, rust_vec_len, data_len),
        96 => wire__crate__backup_invite_codes_impl(port, ptr, rust_vec_len, data_len),
        97 => wire__crate__balance_impl(port, ptr, rust_vec_len, data_len),
        98 => wire__crate__calculate_withdraw_fees_impl(port, ptr, rust_vec_len, data_len),
        99 => wire__crate__create_multimint_from_words_impl(port, ptr, rust_vec_len, data_len),
        100 => wire__crate__create_new_multimint_impl(port, ptr, rust_vec_len, data_len),
        101 => wire__crate__federation_id_to_string_impl(port, ptr, rust_vec_len, data_len),
        102 => wire__crate__federations_impl(port, ptr, rust_vec_len, data_len),
        103 => wire__crate__get_backup_invite_codes_impl(port, ptr, rust_vec_len, data_len),
        104 => wire__crate__get_btc_price_impl(port, ptr, rust_vec_len, data_len),
        105 => wire__crate__get_event_bus_impl(port, ptr, rust_vec_len, data_len),
        106 => wire__crate__get_federation_meta_impl(port, ptr, rust_vec_len, data_len),
        107 => wire__crate__get_max_withdrawable_amount_impl(port, ptr, rust_vec_len, data_len),
        108 => wire__crate__get_mnemonic_impl(port, ptr, rust_vec_len, data_len),
        109 => wire__crate__get_module_recovery_progress_impl(port, ptr, rust_vec_len, data_len),
        110 => wire__crate__get_nwc_connection_info_impl(port, ptr, rust_vec_len, data_len),
        111 => wire__crate__get_relays_impl(port, ptr, rust_vec_len, data_len),
        112 => wire__crate__has_seed_phrase_ack_impl(port, ptr, rust_vec_len, data_len),
        113 => wire__crate__insert_relay_impl(port, ptr, rust_vec_len, data_len),
        114 => wire__crate__join_federation_impl(port, ptr, rust_vec_len, data_len),
        115 => wire__crate__list_federations_from_nostr_impl(port, ptr, rust_vec_len, data_len),
        116 => wire__crate__load_multimint_impl(port, ptr, rust_vec_len, data_len),
        117 => wire__crate__monitor_deposit_address_impl(port, ptr, rust_vec_len, data_len),
        118 => wire__crate__parse_ecash_impl(port, ptr, rust_vec_len, data_len),
        119 => {
            wire__crate__parse_scanned_text_for_federation_impl(port, ptr, rust_vec_len, data_len)
        }
        120 => wire__crate__parsed_scanned_text_impl(port, ptr, rust_vec_len, data_len),
        121 => wire__crate__payment_preview_impl(port, ptr, rust_vec_len, data_len),
        122 => wire__crate__receive_impl(port, ptr, rust_vec_len, data_len),
        123 => wire__crate__reissue_ecash_impl(port, ptr, rust_vec_len, data_len),
        124 => wire__crate__select_receive_gateway_impl(port, ptr, rust_vec_len, data_len),
        125 => wire__crate__send_impl(port, ptr, rust_vec_len, data_len),
        126 => wire__crate__send_ecash_impl(port, ptr, rust_vec_len, data_len),
        127 => wire__crate__send_lnaddress_impl(port, ptr, rust_vec_len, data_len),
        128 => wire__crate__set_nwc_connection_info_impl(port, ptr, rust_vec_len, data_len),
        129 => wire__crate__subscribe_deposits_impl(port, ptr, rust_vec_len, data_len),
        130 => wire__crate__subscribe_multimint_events_impl(port, ptr, rust_vec_len, data_len),
        131 => wire__crate__subscribe_recovery_progress_impl(port, ptr, rust_vec_len, data_len),
        132 => wire__crate__transactions_impl(port, ptr, rust_vec_len, data_len),
        133 => wire__crate__wallet_exists_impl(port, ptr, rust_vec_len, data_len),
        134 => wire__crate__wallet_summary_impl(port, ptr, rust_vec_len, data_len),
        135 => wire__crate__withdraw_to_address_impl(port, ptr, rust_vec_len, data_len),
        136 => wire__crate__word_list_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        67 => wire__crate__nostr__PublicFederation_auto_accessor_get_about_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__crate__nostr__PublicFederation_auto_accessor_get_federation_id_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        69 => wire__crate__nostr__PublicFederation_auto_accessor_get_federation_name_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        70 => wire__crate__nostr__PublicFederation_auto_accessor_get_invite_codes_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__crate__nostr__PublicFederation_auto_accessor_get_modules_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__nostr__PublicFederation_auto_accessor_get_network_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        73 => wire__crate__nostr__PublicFederation_auto_accessor_get_picture_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        74 => wire__crate__nostr__PublicFederation_auto_accessor_set_about_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        75 => wire__crate__nostr__PublicFederation_auto_accessor_set_federation_id_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        76 => wire__crate__nostr__PublicFederation_auto_accessor_set_federation_name_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        77 => wire__crate__nostr__PublicFederation_auto_accessor_set_invite_codes_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        78 => wire__crate__nostr__PublicFederation_auto_accessor_set_modules_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        79 => wire__crate__nostr__PublicFederation_auto_accessor_set_network_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        80 => wire__crate__nostr__PublicFederation_auto_accessor_set_picture_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        81 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_get_fee_amount_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        83 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_get_peg_out_fees_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        84 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_get_tx_size_vbytes_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        85 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_set_fee_amount_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        87 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_set_peg_out_fees_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        88 => wire__crate__multimint__WithdrawFeesResponse_auto_accessor_set_tx_size_vbytes_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
