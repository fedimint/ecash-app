...
class _MnemonicState extends State<Mnemonic>
  ...
  Widget build(BuildContext context) {
    ...
    return SecureScreen(
      // Scrollable so the federation nudge below cannot overflow this
      // fixed-height sheet on shorter screens.
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            // The seed restores funds but records nothing about which
            // federations hold them, so point at the invite codes while the user
            // is in the act of writing their backup down.
            Text(
              context.l10n.seedBackupInviteCodesNudge,
