...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1655290152;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BigInt> crateMultimintMultimintComputeReceiveAmountWithFees({
    required Multimint that,
    required FederationId federationId,
  ...
  Future<BigInt> crateComputeReceiveAmountWithFees({
    required FederationId federationId,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<OperationId> crateExecuteLnurlWithdraw({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [federationId, callback, k1, amountMsats],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateExecuteLnurlWithdrawConstMeta => const TaskConstMeta(
    ...
    argNames: ["federationId", "callback", "k1", "amountMsats"],
  );
