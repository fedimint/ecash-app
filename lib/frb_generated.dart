...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1658456767;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool> crateMultimintMultimintGetTapReceiveEnabled({
    required Multimint that,
  });
  ...
  Future<void> crateMultimintMultimintSetTapReceiveEnabled({
    required Multimint that,
  ...
  Future<bool> crateGetTapReceiveEnabled();
  ...
  Future<void> crateSetTapReceiveEnabled({required bool enabled});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerTapRecipient(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return TapRecipientImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
...
class MultimintImpl extends RustOpaque implements Multimint {
  ...
  Future<bool> getTapReceiveEnabled() => RustLib.instance.api
...
class TapRecipientImpl extends RustOpaque implements TapRecipient {
  // Not to be used by end users
  TapRecipientImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);
  ...
  String decrypt({required List<int> blob}) => RustLib.instance.api
